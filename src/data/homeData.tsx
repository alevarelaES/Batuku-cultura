...
export const getPalopsData = (lang: string) => [
  {
    ...
    featured: true,
    accent: '#1A5CB5',
    flag: '/flags/flag-cape-verde.jpg',
    height: 'h-[460px]',
  ...
  },
  {
    ...
    featured: false,
    accent: '#D4AF37',
    flag: '/flags/flag-guinea-bissau.jpg',
    height: 'h-[360px]',
    width: 'lg:w-[250px] w-[220px]',
  ...
  },
  {
    ...
    featured: false,
    accent: '#2D7A5E',
    flag: '/flags/flag-mozambique.jpg',
    height: 'h-[300px]',
    width: 'lg:w-[250px] w-[220px]',
  ...
  },
  {
    ...
    featured: false,
    accent: '#5C2D82',
    flag: '/flags/flag-sao-tome-principe.jpg',
    height: 'h-[260px]',
    width: 'lg:w-[250px] w-[220px]',
    translate: 'lg:translate-y-12',
    visual: (
